...
#Add the command to start all services
	...
	clear 
	echo "#############################################################"
	echo "Go to your local IP addres, exemple: http://192.168.2.2     #"   
	echo "Project page: https://github.com/giumbai/LinuxNAS           #"
	echo -e "Use the comnad \033[7;36mstart-nas\033[0m to start       #"
	echo "utorrent and VirtualBox. For any proplem report go to github#" 
	echo "#############################################################"
